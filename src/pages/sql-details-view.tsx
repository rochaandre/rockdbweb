...
export function SqlDetailsView() {
    ...
    const [topTab, setTopTab] = usePersistentState('sql-details', 'topTab', 'delta')
    const [bottomTab, setBottomTab] = usePersistentState('sql-details', 'bottomTab', 'active_sessions')
        ...
        <MainLayout>
            <div className="flex flex-col h-full gap-2 p-2 bg-muted/20">
                ...
                <div className="flex items-center gap-2 bg-surface p-1 border border-border rounded-sm text-xs">
                    <Tabs value={topTab} onValueChange={setTopTab} className="w-[200px]">
