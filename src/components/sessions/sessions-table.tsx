            ...
            <table className="w-full text-xs text-left border-collapse table-fixed">
                <thead className="bg-surface-raised sticky top-0 z-10 text-foreground font-medium shadow-sm">
                    <tr>
                        ...
                        <th className="border-b border-r border-border px-1 py-1 w-16 text-right">Completed,%</th>
                        <th className="border-b border-r border-border px-1 py-1 w-14 text-right">Elapsed,s</th>
                        <th className="border-b border-r border-border px-1 py-1 w-14 text-right">Remain,s</th>
                        <th className="border-b border-r border-border px-1 py-1 w-14 text-right">Temp,M</th>
