...
-- after get the plan hash value from AWR, you can get the plan details:
select * from table(DBMS_XPLAN.DISPLAY_AWR(':sql_id',2792955378,NULL,'ALL'));
