...
union all
SELECT 'TABLESPACE' SCHEMA, 'SYSAUX TOTAL SIZE' AREA, to_char(round(sum(bytes)/1024/1024, 2))  SIZE_MB, '100' "SIZE_%"  FROM dba_data_files WHERE tablespace_name = 'SYSAUX'
UNION ALL (
SELECT NULL SCHEMA, NULL AREA, NULL SIZE_MB, NULL "SIZE_%" FROM DUAL WHERE 1 = 0
