SPO /home/oracle/cassiano/coe_xfr_sql_profile.log;
...
PRO
DEF plan_hash_value = '&segundo_param';
PRO
...
SPO OFF;
SPO /home/oracle/cassiano/coe_xfr_sql_profile_&&sql_id._&&plan_hash_value..sql;
DECLARE
  l_pos NUMBER;
  l_clob_size NUMBER;
  l_offset NUMBER;
...
BEGIN
  DBMS_OUTPUT.PUT_LINE('SPO /home/oracle/cassiano/coe_xfr_sql_profile_&&sql_id._&&plan_hash_value..log;');
