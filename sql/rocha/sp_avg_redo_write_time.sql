 ...
 * Modifications:
 *********************************************************************/
set pagesize 10000 linesize 80 trimout on trimspool on verify off pause off
set echo off feedback off timing off
col sort0 noprint
col day heading "Day" format a6
col hr heading "Hour" format a5
col sum_redo_writes format 999G999G999G990 heading "Sum # Redo|Write I/O Rqsts"
col sum_redo_write_time format 999G999G990D00 heading "Sum|Redo Write|Time (secs)"
col avg_redo_writes format 999G999G990D000 heading "Avg # Redo|Write I/O Rqsts|Per Sec"
col avg_redo_write_time format 9990D000 heading "Avg|Redo Write|I/O Rqst|Time (msecs)"
...
spool z:\sp_avg_redo_write_time
...
select	to_char(s.snap_time, 'YYYYMMDD') sort0,
	...
	avg(t.value / w.value)*1000 avg_redo_write_time
from	(select	dbid,
		instance_number,
		snap_id,
