SPO /tmp/coe_xfr_sql_profile.log;
...
SPO OFF;
SPO /tmp/coe_xfr_sql_profile_&&sql_id._&&plan_hash_value..sql;
DECLARE
  l_pos NUMBER;
  l_clob_size NUMBER;
  l_offset NUMBER;
...
BEGIN
  DBMS_OUTPUT.PUT_LINE('SPO /tmp/coe_xfr_sql_profile_&&sql_id._&&plan_hash_value..log;');
